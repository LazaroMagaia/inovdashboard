        ...
        <main class="flex-1 p-6 md:ml-64">
            ...
            <div class="w-full">
                ...
                <div class="bg-white shadow-md rounded-lg p-4">
                    <div class="mb-4">
                        <h4 class="text-lg font-semibold">Permissões Associadas</h4>
                    </div>
                    <form action="{{ route('admin.roles.permissions.delete', $role->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-[#849f54] text-white">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Remover</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($assignedPermissions as $permission)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500">{{ $permission->name }}</td>
                                            <td class="px-6 py-4 text-sm">
                                                <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="form-checkbox h-4 w-4 text-[#849f54]">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    ...
                                    <td colspan="3" class="px-6 py-4 text-right">
                                        @if(!$assignedPermissions->isEmpty())
                                            <button type="submit" class="bg-red-500 text-white py-2 px-4 
                                                rounded hover:bg-red-600 focus:outline-none focus:ring-2 
                                                focus:ring-red-500 mt-2">
                                                Remover Permissões
                                            </button>
                                        @endif
                                    </td>
                ...
                <!-- Permissões Não Associadas -->
                <div class="bg-white shadow-md rounded-lg p-4 mt-4">
                    <div class="mb-4">
                        <h4 class="text-lg font-semibold">Permissões Não Associadas</h4>
                    </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-[#849f54] text-white">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">ID</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Nome</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Adicionar</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3" class="px-6 py-4 text-right">
                                            <button type="submit" class="bg-[#849f54] text-white py-2 
                                                px-4 rounded hover:bg-[#6b9677] focus:outline-none 
                                                    focus:ring-2 focus:ring-[#849f54] mt-2">
...
@include('admin.modals.RolesAndPermissions.roles_permissions')
