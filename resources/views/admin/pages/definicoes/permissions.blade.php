            ...
            <div class="w-full">
                <div class="bg-white shadow-md rounded-lg p-4">
                    <div class="flex justify-between items-center mb-4">
                        <h4 class="text-lg font-semibold">Gerencie as permissões</h4>
                        <button type="button" data-modal-target="#createPermissions" class="bg-[#849f54] text-white px-4 py-2 rounded-lg hover:bg-[#6b9677]">
                            Nova permissão
                        </button>
                    </div>
                                ...
                                <tr data-id="">
                                    ...
                                    <td class="px-6 py-4 text-sm flex gap-2">
                                        <button class="bg-yellow-500 text-white py-1 px-2 rounded 
                                                ...
                                                data-modal-target="#editPermissions{{$permission->id}}">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <button class="bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600
                                             focus:outline-none focus:ring-2 focus:ring-red-500"
                                                data-modal-target="#editDPermissions{{$permission->id}}">
...
@include('admin.modals.RolesAndPermissions.permissionsModal')
