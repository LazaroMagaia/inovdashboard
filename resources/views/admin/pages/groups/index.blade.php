            ...
            <div class="w-full">
                <div class="bg-white shadow rounded-lg p-4">
                    <div class="flex justify-between items-center mb-4">
                        <h4 class="text-xl font-semibold text-[#849f54]">Gerencie os grupos</h4>
                        <button type="button" data-modal-target="#createGroup" 
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white  text-center border">
                            <thead class="bg-[#849f54] text-white">
                                <tr>
                                    <th class="py-2 px-4  text-xs font-medium uppercase 
                                ...
                                <tr data-id="{{ $user->id }}">
                                    ...
                                    <td class="py-2 px-4 border-b ">
                                        <div class=" flex gap-2 justify-center">
                                            <button type="button" data-modal-target="#editarGroup{{$grupo->id}}" 
                                                class="bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-600 
                                                focus:outline-none focus:ring-2 focus:ring-yellow-500">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                            
                                            <button type="button" data-modal-target="#deleteGroup{{$grupo->id}}" 
...
@include('admin.modals.groups.groupModel')
