...
@include('frontend.dashboard.modals.videos')
                ...
                <div class="w-full rounded-lg p-6">
                    ...
                    <section class="grid grid-cols-1 gap-4 mt-5">
                            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                                <div class="p-4">
                                    <h6 class="text-lg font-semibold mb-2 text-center">Nenhum vídeo disponível</h6>
                                </div>
                            </div>
                        @else
                        <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-5">
                            @foreach($videos as $video)
                                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                                    <img 
                                        class="w-full h-40 object-cover" 
                                            src="{{$video->thumbnail_url}}" alt="Card image">
                                    <div class="p-4">
                                        <h6 class="text-lg font-semibold mb-2">{{$video->title}}</h6>
